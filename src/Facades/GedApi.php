...
/**
 * @method static array sign(string $pdfPath, string $pfxPath, string $password, ?array $visualData = null)
 * @method static array signFromBase64(string $pdfBase64, string $pfxContent, string $password, ?array $visualData = null)
